...
- Usa `Seeds/apply_planning_seed.py` cuando una seed cree o modifique `plan_planned_sessions`, para que la prescripcion estructurada canonica en `plan_session_prescriptions` y `plan_prescription_blocks` se actualice en la misma aplicacion.
