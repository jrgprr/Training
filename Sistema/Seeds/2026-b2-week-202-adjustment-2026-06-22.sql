...
SET
    ...
    objective = 'Meter una bici suave Z1 el miercoles sin convertirla en carga y llegar con piernas normales al jueves.',
    ...
    notes = 'El miercoles recupera una bici corta y muy facil, parecida a la prevista inicialmente, pero con techo por debajo de dos horas para no tocar la calidad del jueves.',
    is_key_session = 0,
    intensity_class = 'suave',
    duration_min = 75,
    duration_max = 105,
    adjustment_rule = 'Hacer la bici solo en Z1 y cortar sin problema si aparece fatiga residual; la prioridad sigue siendo proteger el jueves.'
