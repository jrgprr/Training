...
- Semana: 03
- Fechas: 18 de mayo de 2026 a 24 de mayo de 2026
- Estado de entrada: dos semanas encadenadas y primera base de rutina establecida
- Peso de referencia: 91-92 kg
- Tendencia de peso: ligera bajada gradual si la rutina sigue ordenada

## 2. Rol de la semana dentro del bloque

- Funcion dentro de B1: hacer la primera semana realmente constructiva del bloque.
- Tipo de semana: progresion suave.
- Decision esperada al cierre: verificar si el aumento de tiempo aerobico sigue siendo absorbible sin tocar intensidad.

## 3. Objetivo semanal

- Carga principal de la semana: aumentar el tiempo aerobico util y consolidar la semana de 6 dias.
- Prioridad secundaria: introducir la salida de referencia aerobica en formato sencillo.
- Riesgo a vigilar: meter demasiada densidad aprovechando la alta disponibilidad.
- Objetivo de control del peso: que el proceso siga siendo compatible con buena energia para entrenar.
...
- Complementario: revision de datos de la semana.
- Observaciones: si el sabado dejo mas carga de la deseada, bajar este dia a paseo suave.

## 6. Seguimiento y cierre

- Senales de que la semana ha ido bien: la referencia aerobica sale estable, la salida larga entra bien y el domingo sigue siendo util.
- Senales de prudencia: sensacion de piernas vacias, fuerza que interfiere o mala recuperacion tras la salida larga.
- Ajuste permitido para la semana siguiente: bajar carga total y consolidar aunque la semana haya salido bien.