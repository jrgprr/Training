...
- Semana: 06
- Fechas: 8 de junio de 2026 a 14 de junio de 2026
- Estado de entrada: bloque casi consolidado y necesidad de comprobar que la semana tipo ya es repetible
- Peso de referencia: 91 kg aproximados
- Tendencia de peso: descenso gradual compatible con buena recuperacion

## 2. Rol de la semana dentro del bloque

- Funcion dentro de B1: cerrar el bloque y validar el paso a B2.
- Tipo de semana: validacion.
- Decision esperada al cierre: decidir si ya se puede entrar en construccion aerobica extensiva o si hace falta prolongar B1 una semana mas.

## 3. Objetivo semanal

- Carga principal de la semana: repetir una semana tipo solida con buena sensacion global.
- Prioridad secundaria: comprobar que la referencia aerobica y la salida larga encajan dentro de una semana completa.
- Riesgo a vigilar: intentar cerrar el bloque con un exceso final de carga.
- Objetivo de control del peso: mantener el proceso ordenado sin interferir con la salida del bloque.

## 4. Distribucion orientativa

- Dias clave: 1 referencia aerobica y 1 salida larga controlada.
- Dias de soporte: paseo, un dia muy facil y 6 micro-sesiones complementarias de fuerza ligera de lunes a sabado.
- Limite de la semana: terminar con confianza para empezar B2, no con necesidad de descarga urgente.
...
- Distribucion ideal de complementarias: lunes y jueves pecho+triceps+hombro, martes y viernes espalda+biceps, miercoles y sabado core, y domingo sin fuerza.
...
- Senales de prudencia: fatiga arrastrada, fuerza complementaria que sigue interfiriendo o percepcion de semana demasiado cara para repetirla.
