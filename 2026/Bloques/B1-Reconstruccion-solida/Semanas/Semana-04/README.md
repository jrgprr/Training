...
- Semana: 04
- Fechas: 25 de mayo de 2026 a 31 de mayo de 2026
- Estado de entrada: tres semanas de acumulacion suave y necesidad de absorber para seguir progresando
- Peso de referencia: 91-92 kg
- Tendencia de peso: seguimiento sin presion adicional

## 2. Rol de la semana dentro del bloque

- Funcion dentro de B1: consolidar y absorber la carga acumulada.
- Tipo de semana: estabilizacion.
- Decision esperada al cierre: llegar fresco y con ganas de volver a crecer en la semana 05.
...
- Objetivo: cerrar la semana con soltura.
- Sesion principal: paseo largo, monte suave o bicicleta facil 45-60 minutos.
- Complementario: revision de sensaciones generales.
- Observaciones: si aparece cansancio, dejar solo paseo.

## 6. Seguimiento y cierre

- Senales de que la semana ha ido bien: mejora la sensacion de frescura, se duerme mejor y la bici se siente ligera.
- Senales de prudencia: necesidad de seguir vaciando dias, apatía o molestias que no bajan.
- Ajuste permitido para la semana siguiente: volver a crecer solo si reaparece sensacion clara de margen.